...
const PageNotFound = () => {
  ...
  return (
    <>
      <main className="grid min-h-full place-items-center bg-linear-to-br from-purple-400/50 via-orange-300/20 to- to-60%  px-6 py-24 sm:py-32 lg:px-8">
        <div className="text-center">
          <p className="text-base font-semibold text-indigo-800">404</p>
          <h1 className="mt-4 text-5xl font-semibold tracking-tight text-balance text-indigo-800 sm:text-7xl">
            Page not found
          </h1>
